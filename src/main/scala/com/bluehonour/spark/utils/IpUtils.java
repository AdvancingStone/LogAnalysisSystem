...
public class IpUtils {
    ...
    public static String jsonToProvince(String jsonString) {
        //jsonString: {"code":0,"data":{"ip":"171.15.255.255","country":"中国","area":"","region":"河南","city":"信阳","county":"XX","isp":"电信","country_id":"CN","area_id":"","region_id":"410000","city_id":"411500","county_id":"xx","isp_id":"100017"}}
    ...
    public static void main(String[] args) {
        ...
        String ip = "171.15.255.255";
        String address = "";
        try {
            address = addressUtils.getAddresses("ip=" + ip, "utf-8");
            String province = jsonToProvince(address);
